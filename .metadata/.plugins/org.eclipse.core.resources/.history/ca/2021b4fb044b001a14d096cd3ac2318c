package com.orange.extentreport;
...
public class ExtentReportV4 {
	...
	public void extentReportSetup() {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/test-output/ExtentReport_"+dateName+".html");
		...
		extent.setSystemInfo("User Name", "Gaurav Wani");
